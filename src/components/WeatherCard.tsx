...
export default function WeatherCard(props: IAppProps) {
  ...
  return (
    <div className='bg-secondary rounded-md flex flex-col items-center justify-around p-6 sm:flex-auto sm:p-5 sm:px-6 w-38 m-3 space-y-3 lg:flex-none xl:flex-initial '>
